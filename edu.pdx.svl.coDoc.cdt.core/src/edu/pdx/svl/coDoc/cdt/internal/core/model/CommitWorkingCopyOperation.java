 ...
 * <ul>
 * <li>force flag is <code>false</code> - in this case a
 * <code>CModelException</code> is thrown</li>
...
public class CommitWorkingCopyOperation extends CModelOperation {
	...
	protected void executeOperation() throws CModelException {
		try {
			...
			CElementDeltaBuilder deltaBuilder = new CElementDeltaBuilder(
					original);
	 ...
	 * <li>ELEMENT_NOT_PRESENT - the Translation unit the working copy is based
	 * on no longer exists.
	...
	public ICModelStatus verify() {
		...
		if (!wc.isWorkingCopy()) {
			return new CModelStatus(
					ICModelStatusConstants.INVALID_ELEMENT_TYPES, wc);
		}
