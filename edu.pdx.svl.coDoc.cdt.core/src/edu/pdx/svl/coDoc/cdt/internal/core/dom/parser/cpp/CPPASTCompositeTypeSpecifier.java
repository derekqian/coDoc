...
public class CPPASTCompositeTypeSpecifier extends CPPASTBaseDeclSpecifier
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.cpp.ICPPASTCompositeTypeSpecifier#getBaseSpecifiers()
	 */
	public ICPPASTBaseSpecifier[] getBaseSpecifiers() {
		if (baseSpecs == null)
			return ICPPASTBaseSpecifier.EMPTY_BASESPECIFIER_ARRAY;
		baseSpecs = (ICPPASTBaseSpecifier[]) ArrayUtil.removeNullsAfter(
				ICPPASTBaseSpecifier.class, baseSpecs, baseSpecsPos);
		return baseSpecs;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.cpp.ICPPASTCompositeTypeSpecifier#addBaseSpecifier(edu.pdx.svl.coDoc.cdt.core.dom.ast.cpp.ICPPASTCompositeTypeSpecifier.ICPPASTBaseSpecifier)
	 */
	public void addBaseSpecifier(ICPPASTBaseSpecifier baseSpec) {
		if (baseSpec != null) {
			baseSpecsPos++;
			baseSpecs = (ICPPASTBaseSpecifier[]) ArrayUtil.append(
					ICPPASTBaseSpecifier.class, baseSpecs, baseSpec);
		}
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTCompositeTypeSpecifier#getKey()
	 */
	public int getKey() {
		return k;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTCompositeTypeSpecifier#setKey(int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTCompositeTypeSpecifier#getName()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTCompositeTypeSpecifier#setName(edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTName)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTCompositeTypeSpecifier#getMembers()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTCompositeTypeSpecifier#addMemberDeclaration(edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTDeclaration)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTCompositeTypeSpecifier#getScope()
	 */
