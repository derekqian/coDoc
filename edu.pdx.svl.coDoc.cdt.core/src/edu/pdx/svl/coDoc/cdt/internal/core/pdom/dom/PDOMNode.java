 ...
 * 
 * This is a basic node in the PDOM database. PDOM nodes form a multi-root tree
 * with linkages being the roots. This class managed the parent pointer.
 */
public abstract class PDOMNode implements IPDOMNode {
	...
	public static PDOMLinkage getLinkage(PDOM pdom, int record)
