...
/**
 * This is for strings that take up more than on chunk. The string will need to
 * be broken up into sections and then reassembled when necessary.
 * 
...
public class LongString implements IString {
	...
	private static final int LENGTH = 0; // must be first to match
											// ShortString
	...
	private interface IWriter {
		public void writeChars(int start, int length, int p)
