...
import edu.pdx.svl.coDoc.cdt.internal.core.parser.problem.BaseProblemFactory;
 ...
 */
public class ASTProblemFactory extends BaseProblemFactory implements
		IProblemFactory {
	/*
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.problem.IProblemFactory#createProblem(int,
	 *      int, int, int, char[], java.util.Map, boolean, boolean)
	 */
	public IProblem createProblem(int id, int start, int end, int line,
		...
		if (checkBitmask(id, IProblem.INTERNAL_RELATED))
			return createInternalProblem(id, start, end, line, file, arg, warn,
					error);

		if (checkBitmask(id, IProblem.SEMANTICS_RELATED))
			return super.createProblem(id, start, end, line, file, arg, warn,
					error);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.problem.IProblemFactory#getRequiredAttributesForId(int)
	 */
