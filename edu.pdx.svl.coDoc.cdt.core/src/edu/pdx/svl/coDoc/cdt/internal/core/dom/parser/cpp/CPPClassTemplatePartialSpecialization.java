...
public class CPPClassTemplatePartialSpecialization extends CPPClassTemplate
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.cpp.ICPPTemplateSpecialization#getArguments()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.cpp.ICPPClassTemplatePartialSpecialization#getPrimaryClassTemplate()
	 */
	...
	public IBinding instantiate(IType[] args) {
		...
		instance = (ICPPTemplateInstance) CPPTemplates.createInstance(
				(ICPPScope) getScope(), this, argMap, args);
