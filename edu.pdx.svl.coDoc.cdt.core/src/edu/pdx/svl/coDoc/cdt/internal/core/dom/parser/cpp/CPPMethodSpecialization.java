...
public class CPPMethodSpecialization extends CPPFunctionSpecialization
	...
	public CPPMethodSpecialization(IBinding orig, ICPPScope scope,
			ObjectMap argMap) {
	...
	public boolean isVirtual() throws DOMException {
		...
		if (definition != null) {
			...
			if (node instanceof IASTSimpleDeclaration)
				declSpec = (ICPPASTDeclSpecifier) ((IASTSimpleDeclaration) node)
						.getDeclSpecifier();
			else if (node instanceof IASTFunctionDefinition)
				declSpec = (ICPPASTDeclSpecifier) ((IASTFunctionDefinition) node)
						.getDeclSpecifier();
