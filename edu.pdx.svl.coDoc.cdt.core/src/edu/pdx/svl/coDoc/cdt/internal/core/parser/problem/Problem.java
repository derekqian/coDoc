...
public class Problem implements IProblem {
	...
	public Problem(int id, int start, int end, int line, char[] file,
			char[] arg, boolean warn, boolean error) {
		this.id = id;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IProblem#getOriginatingFileName()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IProblem#getSourceEnd()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IProblem#getSourceLineNumber()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IProblem#getSourceStart()
	 */
	...
	public String getMessage() {
		...
		if (originatingFileName != null)
			args = new Object[] { msg, new String(originatingFileName),
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IProblem#checkCategory(int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IProblem#getArguments()
	 */
