...
class PDOMFastHandleDelta extends PDOMFastIndexerJob {
	...
	public PDOMFastHandleDelta(PDOMFastIndexer indexer, ICElementDelta delta)
	...
	public void run(IProgressMonitor monitor) {
		try {
			...
			if (showTimings != null && showTimings.equalsIgnoreCase("true")) //$NON-NLS-1$
				System.out
						.println("PDOM Fast Delta Time: " + (System.currentTimeMillis() - start)); //$NON-NLS-1$
	...
	protected void changeTU(ITranslationUnit tu) throws CoreException,
		...
		PDOMCodeReaderFactory codeReaderFactory = new PDOMCodeReaderFactory(
				pdom);
