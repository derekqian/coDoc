...
/**
 * The CPPImplicitFunction is used to represent implicit functions that exist on
 ...
 * @author dsteffle
 */
public class CPPImplicitFunction extends CPPFunction implements ICPPFunction,
		ICPPInternalBinding {
	...
	public CPPImplicitFunction(char[] name, IScope scope, IType type,
			IParameter[] parms, boolean takesVarArgs) {
		super(null);
		this.name = name;
		this.scope = scope;
	...
	public IFunctionType getType() {
		if (functionType == null) {
			...
			if (primary != null) {
				...
				functionType = CPPVisitor.createImplicitFunctionType(
						returnType, parms);
			}
		}
	...
	public IBinding resolveParameter(IASTParameterDeclaration param) {
		...
		// set the binding for the corresponding parameter in all known defns
		// and decls
		binding = parms[i];
