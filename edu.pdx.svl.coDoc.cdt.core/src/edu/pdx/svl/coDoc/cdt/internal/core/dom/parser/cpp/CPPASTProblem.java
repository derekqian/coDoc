...
public class CPPASTProblem extends CPPASTNode implements IASTProblem {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IASTProblem#getID()
	 */
	public int getID() {
		return id;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IASTProblem#isError()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IASTProblem#isWarning()
	 */
