...
public class ASTMethod extends ASTFunction implements IASTMethod {
	 ...
	 * @param filename
	 */
	public ASTMethod(IASTScope scope, char[] name, List parameters,
			...
			boolean isConstructor, boolean isDestructor, boolean isVirtual,
			boolean isExplicit, boolean isPureVirtual,
			ASTAccessVisibility visibility, List constructorChainElements,
			boolean hasFunctionTryBlock, boolean hasVarArgs, char[] filename) {
		super(scope, name, parameters, returnType, exception, isInline,
				isFriend, isStatic, startOffset, startLine, nameOffset,
				nameEndOffset, ownerTemplate, hasFunctionTryBlock, hasVarArgs,
				nameLine, filename);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTMember#getOwnerClassSpecifier()
	 */
