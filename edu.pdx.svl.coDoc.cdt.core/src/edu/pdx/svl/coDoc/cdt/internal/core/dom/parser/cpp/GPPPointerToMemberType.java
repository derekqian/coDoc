...
import edu.pdx.svl.coDoc.cdt.core.dom.ast.gnu.cpp.IGPPPointerToMemberType;
...
public class GPPPointerToMemberType extends CPPPointerToMemberType implements
	...
	public IType stripQualifiers() {
		GPPPointerToMemberType result = (GPPPointerToMemberType) super
				.stripQualifiers();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.gnu.cpp.IGPPPointerType#isRestrict()
	 */
