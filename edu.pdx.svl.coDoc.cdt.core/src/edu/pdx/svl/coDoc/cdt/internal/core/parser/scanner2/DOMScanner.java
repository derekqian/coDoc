...
public class DOMScanner extends BaseScanner {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IScanner#setASTFactory(edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFactory)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#createInclusionConstruct(char[],
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#processMacro(char[],
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#createReaderDuple(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#pushContext(char[],
	 *      java.lang.Object)
	 */
	protected void pushContext(char[] buffer, Object data) {
		...
		if (data instanceof InclusionData) {
			...
			if (!isCircularInclusion((InclusionData) data)) {
				...
				locationMap.startInclusion(((InclusionData) data).reader,
						inc.o, resolveOffset(getCurrentOffset()));
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#popContext()
	 */
	protected Object popContext() {
		...
		if (result instanceof CodeReader) {
			if (isInitialized)
				...
				bufferDelta[0] += bufferDelta[bufferStackPos + 1]
						+ ((CodeReader) result).buffer.length;
				locationMap.endInclusion(((CodeReader) result),
						getGlobalCounter(0));
			}
			...
			if (data.macro instanceof FunctionStyleMacro && fsmCount == 0) {
				...
				locationMap.endFunctionStyleExpansion(
						((FunctionStyleMacro) data.macro).attachment,
						getGlobalCounter(bufferStackPos + 1) + delta_pos + 1); // functionstyle
				// macro)
				// ;
				bufferDelta[bufferStackPos] += bufferDelta[bufferStackPos + 1]
						+ delta_pos + 1;
			} else if (data.macro instanceof ObjectStyleMacro && fsmCount == 0) {
				locationMap.endObjectStyleMacroExpansion(
						((ObjectStyleMacro) data.macro).attachment,
						getGlobalCounter(bufferStackPos + 1) + delta_pos);
				bufferDelta[bufferStackPos] += bufferDelta[bufferStackPos + 1]
						+ delta_pos;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#quickParsePushPopInclusion(java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#handleProblem(int,
	 *      int, char[])
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#postConstructorSetup(edu.pdx.svl.coDoc.cdt.core.parser.CodeReader,
	 *      edu.pdx.svl.coDoc.cdt.core.parser.IScannerInfo)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#processIfdef(int,
	 *      int, boolean, boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#processIf(int,
	 *      int, boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#processElsif(int,
	 *      int, boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#processElse(int,
	 *      int, boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#processUndef(int,
	 *      int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#processError(int,
	 *      int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#processEndif(int,
	 *      int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.scanner2.BaseScanner#processPragma(int,
	 *      int)
	 */
	...
	private static class _BasicToken implements IToken, ITokenDuple {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.IToken#getFilename()
		 */
		...
		public boolean equals(Object other) {
			...
			if (((IToken) other).getType() != getType())
				return false;
			if (!CharArrayUtils.equals(((IToken) other).getCharImage(),
					getCharImage()))
				return false;
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.IToken#isKeyword()
		 */
		public boolean canBeAPrefix() {
			...
			case tCOMPL:
				return true;
			default:
				if (getType() >= t_and && getType() <= t_xor_eq)
					return true;
				if (getType() >= t__Bool && getType() <= t_restrict)
					return true;
			}
			return false;
		}
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#contains(edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple)
		 */
		public boolean contains(ITokenDuple duple) {
			return (duple.getFirstToken() == duple.getLastToken())
					&& (duple.getFirstToken() == this);
		}

		/*
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#extractNameFromTemplateId()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#findLastTokenType(int)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#getFirstToken()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#getLastSegment()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#getLastToken()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#getLeadingSegments()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#getSegmentCount()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#getStartOffset()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#getSubrange(int, int)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#getTemplateIdArgLists()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#getToken(int)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#isIdentifier()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#iterator()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#length()
		 */
		public int length() {
			return 1;
		}
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#syntaxOfName()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#toQualifiedName()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#freeReferences(edu.pdx.svl.coDoc.cdt.core.parser.ast.IReferenceManager)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#acceptElement(edu.pdx.svl.coDoc.cdt.core.parser.ast.IReferenceManager)
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#getSegmentIterator()
		 */
		...
		// will have dimensions (offset and length) equal to the expanding
		// symbol.
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.IToken#setImage()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.IToken#setImage(char[])
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#toCharArray()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.ITokenDuple#isConversion()
		 */
	...
	private static class _ImagedToken extends _BasicToken {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.token.AbstractToken#getImage()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.parser.IToken#setImage(java.lang.String)
		 */
		public void setImage(String i) {
			image = i.toCharArray();
		}
