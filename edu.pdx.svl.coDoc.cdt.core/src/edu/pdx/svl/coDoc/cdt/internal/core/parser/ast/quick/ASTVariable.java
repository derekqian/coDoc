...
public class ASTVariable extends ASTDeclaration implements IASTVariable {
	 ...
	 * @param filename
	 */
	public ASTVariable(IASTScope scope, char[] name, boolean isAuto,
			...
			IASTExpression constructorExpression, char[] filename) {
		super(scope);
		this.isAuto = isAuto;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTVariable#getName()
	 */
