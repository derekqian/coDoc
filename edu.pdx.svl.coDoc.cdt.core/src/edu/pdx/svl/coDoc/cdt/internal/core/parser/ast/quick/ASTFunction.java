...
public class ASTFunction extends ASTDeclaration implements IASTFunction {
	 ...
	 * @param filename
	 */
	public ASTFunction(IASTScope scope, char[] name, List parameters,
			...
			int nameOffset, int nameEndOffset, IASTTemplate ownerTemplate,
			boolean hasFunctionTryBlock, boolean hasVarArgs, int nameLine,
			char[] filename) {
