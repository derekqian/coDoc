...
public class CPPPointerToMemberType extends CPPPointerType implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.cpp.ICPPPointerToMemberType#getMemberOfClass()
	 */
	public ICPPClassType getMemberOfClass() {
		if (clsType == null) {
			...
			if (binding instanceof ICPPClassType) {
				...
				clsType = new CPPClassType.CPPClassTypeProblem(name,
						IProblemBinding.SEMANTIC_INVALID_TYPE, name
								.toCharArray());
			}
		}
		return clsType;
