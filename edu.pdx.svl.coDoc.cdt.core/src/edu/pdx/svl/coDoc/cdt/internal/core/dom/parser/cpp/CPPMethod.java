...
public class CPPMethod extends CPPFunction implements ICPPMethod {
	public static class CPPMethodDelegate extends
			CPPFunction.CPPFunctionDelegate implements ICPPMethod {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.cpp.ICPPMethod#isDestructor()
		 */
	...
	public static class CPPMethodProblem extends CPPFunctionProblem implements
			ICPPMethod {
		/**
		 * @param id
		 * @param arg
	...
	public IASTDeclaration getPrimaryDeclaration() throws DOMException {
		...
		for (int i = 0; i < members.length; i++) {
			if (members[i] instanceof IASTSimpleDeclaration) {
				...
				IASTName name = ((IASTFunctionDefinition) members[i])
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.cpp.ICPPMethod#isVirtual()
	 */
	public boolean isVirtual() throws DOMException {
		IASTDeclaration decl = getPrimaryDeclaration();
		if (decl != null) {
			...
			if (decl instanceof IASTSimpleDeclaration)
				declSpec = (ICPPASTDeclSpecifier) ((IASTSimpleDeclaration) decl)
						.getDeclSpecifier();
			else if (decl instanceof IASTFunctionDefinition)
				declSpec = (ICPPASTDeclSpecifier) ((IASTFunctionDefinition) decl)
						.getDeclSpecifier();
