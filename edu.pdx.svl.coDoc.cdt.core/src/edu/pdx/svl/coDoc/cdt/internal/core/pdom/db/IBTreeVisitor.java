 ...
 * 
 * The visitor walks through the tree until the compare returns >= 0, i.e. we
 * reach the first record that meets the criteria.
 * 
...
public interface IBTreeVisitor {
	...
	/**
	 * Compare the record against an internally held key. Used for visiting.
	 * 
	 * @param record
