...
public interface ITemplateSymbol extends IParameterizedSymbol {
	 ...
	 *             Reason: r_BadTemplateParameter if the Parameter does not have
	 *             type TypeInfo.t_templateParameter or if the parameter has the
	 *             same name as the template or if the parameter is a non-type
	 *             parameter and does not have a valid type (14.1-4, 14.1-7)
	 */
	 ...
	 * @return
	 * @throws ParserSymbolTableException
	 *             Reason: r_BadTemplateArgument if an argument does not match
	 *             the corresponding parameter type r_Ambiguous if more than one
	 *             specialization can be used but none is more specialized than
	 *             all the others
	 */
