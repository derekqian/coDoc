 ...
 * @author aniefer
 */
public class CVariable extends PlatformObject implements IVariable,
		ICInternalBinding {
	public static class CVariableProblem extends ProblemBinding implements
			IVariable {
	...
	public IScope getScope() {
		IASTDeclarator declarator = (IASTDeclarator) declarations[0]
				.getParent();
