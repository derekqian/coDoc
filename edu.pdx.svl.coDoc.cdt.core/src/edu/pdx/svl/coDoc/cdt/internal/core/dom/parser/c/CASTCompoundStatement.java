...
public class CASTCompoundStatement extends CASTNode implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTCompoundStatement#getStatements()
	 */
	public IASTStatement[] getStatements() {
		if (statements == null)
			return IASTStatement.EMPTY_STATEMENT_ARRAY;
		return (IASTStatement[]) ArrayUtil.removeNulls(IASTStatement.class,
				statements);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTCompoundStatement#addStatement(edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTStatement)
	 */
	public void addStatement(IASTStatement statement) {
		statements = (IASTStatement[]) ArrayUtil.append(IASTStatement.class,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTCompoundStatement#resolveBinding()
	 */
