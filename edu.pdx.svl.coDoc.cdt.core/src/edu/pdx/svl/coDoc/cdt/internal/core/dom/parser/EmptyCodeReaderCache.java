...
/**
 * This is an empty implementation of the ICodeReaderCache interface. It is used
 * to implement a cache for the interface that isn't actually a cache, but
 * rather always creates new CodeReaders everytime a CodeReader is retrieved.
 * 
 * This cache is not optimized to be run from within Eclipse (i.e. it ignores
 * IResources).
 * 
 * @author dsteffle
 */
