...
import edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICBasicType;
...
public class CBasicType implements ICBasicType {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IBasicType#getType()
	 */
	public int getType() {
		return type;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IBasicType#isSigned()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IBasicType#isUnsigned()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IBasicType#isShort()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IBasicType#isLong()
	 */
	...
	public boolean isSameType(IType obj) {
		...
		return (cObj.getType() == this.getType()
				...
				&& cObj.isComplex() == this.isComplex() && cObj.isImaginary() == this
				.isImaginary());
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IBasicType#getValue()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICBasicType#isComplex()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICBasicType#isImaginary()
	 */
