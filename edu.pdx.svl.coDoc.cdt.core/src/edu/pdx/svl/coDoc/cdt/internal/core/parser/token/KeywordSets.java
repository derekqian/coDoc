...
import edu.pdx.svl.coDoc.cdt.core.parser.Directives;
...
public class KeywordSets {
	...
	static {
		...
		DECL_SPECIFIER_SEQUENCE_TABLE.put(ParserLanguage.CPP,
				DECL_SPECIFIER_SEQUENCE_CPP);
		DECL_SPECIFIER_SEQUENCE_TABLE.put(ParserLanguage.C,
				DECL_SPECIFIER_SEQUENCE_C);
	}
