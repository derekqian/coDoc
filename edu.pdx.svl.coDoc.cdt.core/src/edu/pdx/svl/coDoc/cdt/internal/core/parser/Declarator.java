...
public class Declarator implements IParameterCollection, IDeclaratorOwner,
	 ...
	 * @param specification
	 */
	public void setExceptionSpecification(
			IASTExceptionSpecification specification) {
	 ...
	 * @param initializer
	 */
	public void addConstructorMemberInitializer(
			IASTConstructorMemberInitializer initializer) {
		if (constructorMemberInitializers == Collections.EMPTY_LIST)
			constructorMemberInitializers = new ArrayList(
					DEFAULT_ARRAYLIST_SIZE);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.IDeclaratorOwner#getDeclarators()
	 */
