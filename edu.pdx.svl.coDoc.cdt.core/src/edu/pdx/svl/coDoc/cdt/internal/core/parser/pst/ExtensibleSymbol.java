...
public class ExtensibleSymbol implements Cloneable, IExtensibleSymbol {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.pst.IExtensibleSymbol#getSymbolTable()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.pst.IExtensibleSymbol#getASTExtension()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.pst.IExtensibleSymbol#setASTExtension(edu.pdx.svl.coDoc.cdt.internal.core.parser.pst.ISymbolASTExtension)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.pst.IExtensibleSymbol#getContainingSymbol()
	 */
