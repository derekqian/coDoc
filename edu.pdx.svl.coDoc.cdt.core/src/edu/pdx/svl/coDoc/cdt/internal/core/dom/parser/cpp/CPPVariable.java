 ...
 * @author aniefer
 */
public class CPPVariable extends PlatformObject implements ICPPVariable,
		ICPPInternalBinding {
	public static class CPPVariableDelegate extends CPPDelegate implements
			ICPPVariable {
	...
	public static class CPPVariableProblem extends ProblemBinding implements
			ICPPVariable {
	...
	protected boolean isDefinition(IASTName name) {
		...
		IASTSimpleDeclaration simpleDecl = (IASTSimpleDeclaration) dtor
				.getParent();
		IASTDeclSpecifier declSpec = simpleDecl.getDeclSpecifier();

		// (3.1-1) A declaration is a definition unless ...
		// it contains the extern specifier or a linkage-spec and does not
	...
	public IScope getScope() {
		return CPPVisitor.getContainingScope(definition != null ? definition
				: declarations[0]);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.cpp.ICPPMember#isStatic()
	 */
	public boolean isStatic() {
		...
		if (node instanceof IASTSimpleDeclaration) {
			IASTDeclSpecifier declSpec = ((IASTSimpleDeclaration) node)
					.getDeclSpecifier();
		...
		do {
			if (name != null) {
				...
				if (parent instanceof IASTSimpleDeclaration) {
					IASTDeclSpecifier declSpec = ((IASTSimpleDeclaration) parent)
							.getDeclSpecifier();
	...
	public boolean isMutable() {
		// 7.1.1-8 the mutable specifier can only be applied to names of class
		// data members
		return false;
	}
