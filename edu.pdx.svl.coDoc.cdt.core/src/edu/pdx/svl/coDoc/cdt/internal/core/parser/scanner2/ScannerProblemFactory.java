 ...
 * 
 */
public class ScannerProblemFactory extends BaseProblemFactory implements
		IProblemFactory {
	/*
	 * (non-Javadoc)
	 * 
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.IProblemFactory#getRequiredAttributesForId(int)
	 */
