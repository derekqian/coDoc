...
public class TypeInfoProvider {
	...
	static final public ITypeInfo newTypeInfo(ITypeInfo topInfo) {
		ITypeInfo newInfo = newInfo(topInfo.getType(),
				topInfo.getDefault() != null);
	 ...
	 * @return
	 */
	static final public ITypeInfo newTypeInfo(eType type, int bits,
			ISymbol typeSymbol, PtrOp ptrOp, boolean hasDefault) {
	 ...
	 * @return
	 */
	public final static ITypeInfo newTypeInfo(eType type, int bits,
			ISymbol symbol, PtrOp op, Object def) {
	...
	public void setTemplateParameterType(eType t) {
		templateParamType = t;
	}
	...
	public ITypeInfo completeConstruction() {
		ITypeInfo newInfo = newTypeInfo(type, bits, typeSymbol, null,
				defaultObj);
