...
public class ExpressionFactory {
	...
	public static ASTExpression createExpression(Kind kind, IASTExpression lhs,
			IASTExpression rhs, IASTExpression thirdExpression,
			IASTTypeId typeId, ITokenDuple idExpression, char[] literal,
		...
		if (thirdExpression != null)
			return new ASTConditionalExpression(kind, references, lhs, rhs,
					thirdExpression);
