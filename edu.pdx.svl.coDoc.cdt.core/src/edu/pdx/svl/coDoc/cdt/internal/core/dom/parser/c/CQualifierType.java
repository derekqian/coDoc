...
import edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICQualifierType;
...
public class CQualifierType implements ICQualifierType, ITypeContainer {
	 ...
	 * 
	 * @param type
	 *            the CQualifierType's IBasicType
	 */
	...
	public CQualifierType(IType type, boolean isConst, boolean isVolatile,
			boolean isRestrict) {
		this.type = type;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IQualifierType#isConst()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IQualifierType#isVolatile()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICQualifierType#isRestrict()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IQualifierType#getType()
	 */
	private IType resolveType(ICASTDeclSpecifier declSpec) {
		...
		if (declSpec instanceof ICASTTypedefNameSpecifier) {
			...
			t = new CEnumeration(((IASTEnumerationSpecifier) declSpec)
					.getName());
		} else {
