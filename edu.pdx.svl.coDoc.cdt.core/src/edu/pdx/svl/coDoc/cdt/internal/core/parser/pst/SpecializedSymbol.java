...
public class SpecializedSymbol extends TemplateSymbol implements
		ISpecializedSymbol {
	...
	public ISymbol instantiate(List arguments)
		...
		for (int i = 0; i < numSpecArgs; i++) {
			...
			// yet, defer for later
			if (mappedInfo.isType(ITypeInfo.t_type)
					&& mappedInfo.getTypeSymbol().isType(
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.pst.IParameterizedSymbol#getArgumentList()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.parser.pst.IParameterizedSymbol#addArgument(edu.pdx.svl.coDoc.cdt.internal.core.parser.pst.ISymbol)
	 */
	public void addArgument(ITypeInfo arg) {
		...
		// arg.setIsTemplateMember( isTemplateMember() || getType() ==
		// TypeInfo.t_template );
	...
	private List _argumentList = Collections.EMPTY_LIST; // template
