 ...
 * @author dsteffle
 */
public class CASTKnRFunctionDeclarator extends CASTDeclarator implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.gnu.c.ICASTKnRFunctionDeclarator#setParameterNames(edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTName[])
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.gnu.c.ICASTKnRFunctionDeclarator#getParameterNames()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.gnu.c.ICASTKnRFunctionDeclarator#setParameterDeclarations(edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTDeclaration[])
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.gnu.c.ICASTKnRFunctionDeclarator#getParameterDeclarations()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.gnu.c.ICASTKnRFunctionDeclarator#getDeclaratorForParameterName()
	 */
		...
		for (int i = 0; i < parameterDeclarations.length; i++) {
			if (parameterDeclarations[i] instanceof IASTSimpleDeclaration) {
				...
				for (int j = 0; j < decltors.length; j++) {
					if (decltors[j].getName().toString()
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.dom.parser.c.CASTDeclarator#getRoleForName(edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTName)
	 */
