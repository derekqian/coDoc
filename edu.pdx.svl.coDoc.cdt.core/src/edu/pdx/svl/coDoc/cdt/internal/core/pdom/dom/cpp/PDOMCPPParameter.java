...
public class PDOMCPPParameter extends PDOMNamedNode implements ICPPParameter {
	...
	public PDOMCPPParameter(PDOM pdom, PDOMNode parent, IASTName name,
			ICPPParameter param) throws CoreException {
		...
		if (type != null) {
			...
			db.putInt(record + TYPE, typeNode != null ? typeNode.getRecord()
					: 0);
		}
	}
	...
	public void setNextParameter(PDOMCPPParameter nextParam)
	...
	public IType getType() throws DOMException {
		try {
			PDOMNode node = getLinkage().getNode(
					pdom.getDB().getInt(record + TYPE));
