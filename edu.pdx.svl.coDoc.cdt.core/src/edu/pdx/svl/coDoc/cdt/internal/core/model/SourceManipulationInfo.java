...
class SourceManipulationInfo extends CElementInfo {
	...
	protected ISourceRange getSourceRange() {
		return new SourceRange(fStartPos, fLength, fIdStartPos, fIdLength,
				fStartLine, fEndLine);
	}
	...
	public String getSource() throws CModelException {
		...
		// throw new CModelException(bound,
	...
	public void copy(ICElement container, ICElement sibling, String rename,
		...
		getElement().getCModel().copy(elements, containers, siblings,
	...
	public void move(ICElement container, ICElement sibling, String rename,
		...
		getElement().getCModel().move(elements, containers, siblings,
				renamings, force, monitor);
	}
	...
	public void rename(String name, boolean force, IProgressMonitor monitor)
		...
		getElement().getCModel().rename(elements, dests, renamings, force,
				monitor);
	}
