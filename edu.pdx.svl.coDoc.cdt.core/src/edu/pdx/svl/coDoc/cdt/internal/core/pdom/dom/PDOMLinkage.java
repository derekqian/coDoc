...
public abstract class PDOMLinkage extends PDOMNamedNode {
	...
	protected PDOMLinkage(PDOM pdom, String languageId, char[] name)
	...
	public static int getNextLinkageRecord(PDOM pdom, int record)
			throws CoreException {
	...
	public abstract PDOMBinding addName(IASTName name, PDOMFile file)
			throws CoreException;

	public abstract PDOMBinding adaptBinding(IBinding binding)
			throws CoreException;

	public abstract IBinding resolveBinding(IASTName name) throws CoreException;

	public abstract void findBindings(Pattern pattern, List bindings)
			throws CoreException;
