 ...
 */
package edu.pdx.svl.coDoc.cdt.internal.core.parser.ast.complete.gcc;
...
import edu.pdx.svl.coDoc.cdt.internal.core.parser.BacktrackException;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.DeclarationWrapper;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.Declarator;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.ast.GCCASTExtension;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.ast.complete.ASTBinaryExpression;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.ast.complete.ASTEmptyExpression;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.ast.complete.ASTSimpleTypeSpecifier;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.ast.complete.ASTTypeIdExpression;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.ast.complete.ASTUnaryExpression;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.ast.complete.ExpressionFactory;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.pst.ITypeInfo;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.token.ImagedToken;
import edu.pdx.svl.coDoc.cdt.internal.core.parser.token.SimpleToken;
...
public class GCCASTCompleteExtension extends GCCASTExtension {
	...
	public boolean overrideCreateExpressionMethod() {
		if (mode == ParserMode.STRUCTURAL_PARSE
				|| mode == ParserMode.COMPLETE_PARSE)
			return true;
		return false;
	}

	protected IASTExpression createExpression(IASTExpression.Kind kind,
	 ...
	 */
	private void __builtin_inf(IASTFactory factory,
			IASTCompilationUnit compilationUnit) {
		try {
			// double __builtin_inf (void)
			DeclarationWrapper sdw = new DeclarationWrapper(compilationUnit, 0,
					0, null, EMPTY_STRING);
			IASTSimpleTypeSpecifier typeSpec = factory
					.createSimpleTypeSpecifier(compilationUnit,
							IASTSimpleTypeSpecifier.Type.DOUBLE,
							new SimpleToken(IToken.t_double, -1, EMPTY_STRING,
									-1), false, false, false, false, false,
							false, false, false, Collections.EMPTY_MAP);
			sdw.setTypeSpecifier(typeSpec);
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_INF,
					__BUILTIN_INF.length, EMPTY_STRING, 0));
			DeclarationWrapper param = new DeclarationWrapper(compilationUnit,
					0, 0, null, EMPTY_STRING);
			param.setTypeSpecifier(factory.createSimpleTypeSpecifier(
					compilationUnit, IASTSimpleTypeSpecifier.Type.VOID,
					new SimpleToken(IToken.t_void, -1, EMPTY_STRING, -1),
		...
		try {
			...
			IASTSimpleTypeSpecifier typeSpec = factory
					.createSimpleTypeSpecifier(compilationUnit,
							...
							new SimpleToken(IToken.t_float, -1, EMPTY_STRING,
									-1), false, false, false, false, false,
							false, false, false, Collections.EMPTY_MAP);
			sdw.setTypeSpecifier(typeSpec);
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_INFF,
					__BUILTIN_INFF.length, EMPTY_STRING, 0));
			DeclarationWrapper param = new DeclarationWrapper(compilationUnit,
					0, 0, null, EMPTY_STRING);
			param.setTypeSpecifier(factory.createSimpleTypeSpecifier(
					compilationUnit, IASTSimpleTypeSpecifier.Type.VOID,
		...
		try {
			...
			IASTSimpleTypeSpecifier typeSpec = factory
					.createSimpleTypeSpecifier(compilationUnit,
							IASTSimpleTypeSpecifier.Type.DOUBLE, duple, false,
							true, false, false, false, false, false, false,
							Collections.EMPTY_MAP);
			sdw.setTypeSpecifier(typeSpec);
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_INFL,
					__BUILTIN_INFL.length, EMPTY_STRING, 0));
			DeclarationWrapper param = new DeclarationWrapper(compilationUnit,
					0, 0, null, EMPTY_STRING);
			param.setTypeSpecifier(factory.createSimpleTypeSpecifier(
					compilationUnit, IASTSimpleTypeSpecifier.Type.VOID,
	 ...
	 * @param compilationUnit
	 */
	private void __builtin_huge_val(IASTFactory factory,
			IASTCompilationUnit compilationUnit) {
		try {
			...
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_HUGE_VAL,
					__BUILTIN_HUGE_VAL.length, EMPTY_STRING, 0));
			DeclarationWrapper param = new DeclarationWrapper(compilationUnit,
					0, 0, null, EMPTY_STRING);
			param.setTypeSpecifier(factory.createSimpleTypeSpecifier(
					compilationUnit, IASTSimpleTypeSpecifier.Type.VOID,
		...
		try {
			...
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_HUGE_VALF,
					__BUILTIN_HUGE_VALF.length, EMPTY_STRING, 0));
			DeclarationWrapper param = new DeclarationWrapper(compilationUnit,
					0, 0, null, EMPTY_STRING);
			param.setTypeSpecifier(factory.createSimpleTypeSpecifier(
					compilationUnit, IASTSimpleTypeSpecifier.Type.VOID,
		...
		try {
			...
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_HUGE_VALL,
					__BUILTIN_HUGE_VALL.length, EMPTY_STRING, 0));
			DeclarationWrapper param = new DeclarationWrapper(compilationUnit,
					0, 0, null, EMPTY_STRING);
			param.setTypeSpecifier(factory.createSimpleTypeSpecifier(
					compilationUnit, IASTSimpleTypeSpecifier.Type.VOID,
	 ...
	 * @param compilationUnit
	 */
	private void __builtin_prefetch(IASTFactory factory,
			IASTCompilationUnit compilationUnit) {
		try {
			...
			IASTSimpleTypeSpecifier typeSpec = factory
					.createSimpleTypeSpecifier(compilationUnit,
							IASTSimpleTypeSpecifier.Type.VOID, new SimpleToken(
									IToken.t_void, -1, EMPTY_STRING, -1),
							false, false, false, false, false, false, false,
							false, Collections.EMPTY_MAP);
			sdw.setTypeSpecifier(typeSpec);
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_PREFETCH,
					__BUILTIN_PREFETCH.length, EMPTY_STRING, 0));
			DeclarationWrapper param = new DeclarationWrapper(compilationUnit,
					0, 0, null, EMPTY_STRING);
	 ...
	 * @param compilationUnit
	 */
	private void __builtin_expect(IASTFactory factory,
			IASTCompilationUnit compilationUnit) {
		try {
			...
			IASTSimpleTypeSpecifier typeSpec = factory
					.createSimpleTypeSpecifier(compilationUnit,
							IASTSimpleTypeSpecifier.Type.INT, new SimpleToken(
									IToken.t_long, -1, EMPTY_STRING, -1),
							false, true, false, false, false, false, false,
							false, Collections.EMPTY_MAP);
			sdw.setTypeSpecifier(typeSpec);
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_EXPECT,
					__BUILTIN_EXPECT.length, EMPTY_STRING, 0));
			DeclarationWrapper param = new DeclarationWrapper(compilationUnit,
					0, 0, null, EMPTY_STRING);
			param.setTypeSpecifier(typeSpec);
			param.addDeclarator(new Declarator(param));
	 ...
	 * @param compilationUnit
	 */
	private void __builtin_va_list(IASTFactory factory,
			IASTCompilationUnit compilationUnit) {
		try {
			IASTSimpleTypeSpecifier typeSpec = factory
					.createSimpleTypeSpecifier(compilationUnit,
							IASTSimpleTypeSpecifier.Type.CHAR, new SimpleToken(
									IToken.t_char, -1, EMPTY_STRING, -1),
							false, false, false, false, false, false, false,
							true, Collections.EMPTY_MAP);
			List pointers = new ArrayList(1);
			pointers.add(ASTPointerOperator.POINTER);
			IASTAbstractDeclaration abs = factory.createAbstractDeclaration(
					false, false, typeSpec, pointers, Collections.EMPTY_LIST,
					Collections.EMPTY_LIST, null);
			factory.createTypedef(compilationUnit, __BUILTIN_VA_LIST, abs, -1,
					-1, -1, -1, -1, EMPTY_STRING);
		} catch (ASTSemanticException ase) { // nothing
		}
	}

	private void __builtin_nan(IASTFactory factory,
			IASTCompilationUnit compilationUnit) {
		// const char *
		DeclarationWrapper param = new DeclarationWrapper(compilationUnit, 0,
				0, null, EMPTY_STRING);
		try {
			param.setTypeSpecifier(factory.createSimpleTypeSpecifier(
					compilationUnit, IASTSimpleTypeSpecifier.Type.CHAR,
					new SimpleToken(IToken.t_char, -1, EMPTY_STRING, -1),
					false, false, false, false, false, false, false, false,
					Collections.EMPTY_MAP));
		...
		try {
			...
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_NAN,
					__BUILTIN_NAN.length, EMPTY_STRING, 0));
			d.addParameter(param);
			sdw.addDeclarator(d);
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e) { // nothing
		...
		try {
			...
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_NANF,
					__BUILTIN_NANF.length, EMPTY_STRING, 0));
			d.addParameter(param);
			sdw.addDeclarator(d);
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e) { // nothing
		...
		try {
			...
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_NANL,
					__BUILTIN_NANL.length, EMPTY_STRING, 0));
			d.addParameter(param);
			sdw.addDeclarator(d);
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e) { // nothing
		...
		try {
			...
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_NANS,
					__BUILTIN_NANS.length, EMPTY_STRING, 0));
			d.addParameter(param);
			sdw.addDeclarator(d);
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e) { // nothing
		...
		try {
			...
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_NANSF,
					__BUILTIN_NANSF.length, EMPTY_STRING, 0));
			d.addParameter(param);
			sdw.addDeclarator(d);
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e) { // nothing
		...
		try {
			...
			Declarator d = new Declarator(sdw);
			d.setIsFunction(true);
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_NANSL,
					__BUILTIN_NANSL.length, EMPTY_STRING, 0));
			d.addParameter(param);
			sdw.addDeclarator(d);
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e) { // nothing
	...
	private void __builtin_unsigned_int(IASTFactory factory,
			IASTCompilationUnit compilationUnit) {
		// unsigned int
		DeclarationWrapper param = new DeclarationWrapper(compilationUnit, 0,
				0, null, EMPTY_STRING);
		try {
			...
			ITokenDuple duple = TokenFactory.createTokenDuple(t1, t2);
			param.setTypeSpecifier(factory.createSimpleTypeSpecifier(
					compilationUnit, IASTSimpleTypeSpecifier.Type.INT, duple,
		...
		DeclarationWrapper sdw = new DeclarationWrapper(compilationUnit, 0, 0,
				null, EMPTY_STRING);
		Declarator d = new Declarator(sdw);
		d.setIsFunction(true);
		...
		try {
			IASTSimpleTypeSpecifier typeSpec = factory
					.createSimpleTypeSpecifier(compilationUnit,
							IASTSimpleTypeSpecifier.Type.INT, new SimpleToken(
									IToken.t_int, -1, EMPTY_STRING, -1), false,
							false, false, false, false, false, false, false,
							Collections.EMPTY_MAP);
			sdw.setTypeSpecifier(typeSpec);
		} catch (ASTSemanticException e) { // nothing
		...
		try {// int __builtin_ffs(unsigned int x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_FFS,
					__BUILTIN_FFS.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		...
		try {// int __builtin_cls(unsigned int x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_CLZ,
					__BUILTIN_CLZ.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
		...
		try {// int __builtin_ctz(unsigned int x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_CTZ,
					__BUILTIN_CTZ.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
		...
		try {// int __builtin_popcount(unsigned int x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_POPCOUNT,
					__BUILTIN_POPCOUNT.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
		try {// int __builtin_parity(unsigned int x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_PARITY,
					__BUILTIN_PARITY.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
	...
	private void __builtin_unsigned_long(IASTFactory factory,
		...
		try {// int __builtin_ffsl(unsigned int x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_FFSL,
					__BUILTIN_FFSL.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) { // nothing
		} catch (BacktrackException e2) {// nothing
		}
		...
		try {// int __builtin_clsl(unsigned int x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_CLZL,
					__BUILTIN_CLZL.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
		...
		try {// int __builtin_ctzl(unsigned int x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_CTZL,
					__BUILTIN_CTZL.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
		...
		try {// int __builtin_popcountl(unsigned int x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_POPCOUNTL,
					__BUILTIN_POPCOUNTL.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
		try {// int __builtin_parityl(unsigned int x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_PARITYL,
					__BUILTIN_PARITYL.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
	...
	private void __builtin_unsigned_long_long(IASTFactory factory,
			IASTCompilationUnit compilationUnit) {
		// unsigned long long
		DeclarationWrapper param = new DeclarationWrapper(compilationUnit, 0,
				0, null, EMPTY_STRING);
		try {
			...
			IASTSimpleTypeSpecifier spec = factory.createSimpleTypeSpecifier(
					compilationUnit, IASTSimpleTypeSpecifier.Type.INT, duple,
					false, true, false, true, false, false, false, false,
					Collections.EMPTY_MAP);
			// TODO modify the typeSpec to be long long instead of long, this
			// won't be necessary once we parse long long properly
			((ASTSimpleTypeSpecifier) spec).getSymbol().getTypeInfo().setBit(
					false, ITypeInfo.isLong);
			((ASTSimpleTypeSpecifier) spec).getSymbol().getTypeInfo().setBit(
					true, ITypeInfo.isLongLong);
		...
		try {// int __builtin_ffsll(unsigned long long x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_FFSLL,
					__BUILTIN_FFSLL.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) { // nothing
		} catch (BacktrackException e2) {// nothing
		}
		...
		try {// int __builtin_clsll(unsigned long long x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_CLZLL,
					__BUILTIN_CLZLL.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
		...
		try {// int __builtin_ctzll(unsigned long long x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_CTZLL,
					__BUILTIN_CTZLL.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
		...
		try {// int __builtin_popcountll(unsigned long long x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_POPCOUNTLL,
					__BUILTIN_POPCOUNTLL.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
		try {// int __builtin_parityll(unsigned long long x)
			d.setName(new ImagedToken(IToken.tIDENTIFIER, __BUILTIN_PARITYLL,
					__BUILTIN_PARITYLL.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) {// nothing
		} catch (BacktrackException e2) {// nothing
		}
	...
	private void __builtin_types_compatible_p(IASTFactory factory,
			IASTCompilationUnit compilationUnit) {
		DeclarationWrapper sdw = new DeclarationWrapper(compilationUnit, 0, 0,
				null, EMPTY_STRING);
		Declarator d = new Declarator(sdw);
		...
		try {// int __builtin_types_compatible_p( type1, type2 ) implemented
				// via ( ... )
			d.setName(new ImagedToken(IToken.tIDENTIFIER,
					__BUILTIN_TYPES_COMPATIBLE_P,
					__BUILTIN_TYPES_COMPATIBLE_P.length, EMPTY_STRING, 0));
			sdw.createASTNodes(factory);
		} catch (ASTSemanticException e2) { // nothing
		} catch (BacktrackException e2) {// nothing
		}
