 ...
 * 
 */
public class ASTUsingDirective extends ASTAnonymousDeclaration implements
		IASTUsingDirective {
	 ...
	 * @param nLine
	 */
	// public ASTUsingDirective(IContainerSymbol ownerSymbol,
	// IASTNamespaceDefinition namespaceDefinition, int startingOffset, int
	// endingOffset, List references )
	public ASTUsingDirective(IContainerSymbol ownerSymbol,
			IUsingDirectiveSymbol usingDirective, int startingOffset,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTUsingDirective#getNamespaceName()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTUsingDirective#getNamespaceDefinition()
	 */
	public IASTNamespaceDefinition getNamespaceDefinition() {
		IContainerSymbol namespaceSymbol = using.getNamespace();

		return (IASTNamespaceDefinition) namespaceSymbol.getASTExtension()
