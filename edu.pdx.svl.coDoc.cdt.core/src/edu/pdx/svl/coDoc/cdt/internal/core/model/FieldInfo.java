...
public class FieldInfo extends SourceManipulationInfo {
	...
	/**
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.model.SourceManipulationInfo#hasSameContentsAs(SourceManipulationInfo)
	 */
	public boolean hasSameContentsAs(SourceManipulationInfo info) {
		...
		return (super.hasSameContentsAs(info)
				...
				&& (visibility == ((FieldInfo) info).getVisibility()) && (isStatic == ((FieldInfo) info)
				.isStatic()));
	}
