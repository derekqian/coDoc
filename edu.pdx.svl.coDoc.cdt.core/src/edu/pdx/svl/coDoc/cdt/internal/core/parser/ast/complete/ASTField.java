...
public class ASTField extends ASTVariable implements IASTField {
	 ...
	 * @param filename
	 */
	public ASTField(ISymbol newSymbol,
			...
			List references, boolean previouslyDeclared,
			IASTExpression constructorExpression,
			ASTAccessVisibility visibility, char[] filename) {
		super(newSymbol, abstractDeclaration, initializerClause,
				bitfieldExpression, startingOffset, startingLine, nameOffset,
				nameEndOffset, nameLine, references, constructorExpression,
				previouslyDeclared, filename);
