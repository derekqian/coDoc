...
public class ASTNewDescriptor implements IASTNewExpressionDescriptor {
	...
	public ASTNewDescriptor(List newPlacementExpressions,
			List newTypeIdExpressions, List newInitializerExpressions) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTExpression.IASTNewExpressionDescriptor#getExpressions()
	 */
