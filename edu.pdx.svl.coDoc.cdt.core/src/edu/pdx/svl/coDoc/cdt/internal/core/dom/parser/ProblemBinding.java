 ...
 * @author aniefer
 */
public class ProblemBinding extends PlatformObject implements IProblemBinding,
		IType, IScope {
	...
	static {
		...
		errorMessages[SEMANTIC_NAME_NOT_FOUND - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.nameNotFound"); //$NON-NLS-1$
		errorMessages[SEMANTIC_AMBIGUOUS_LOOKUP - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.pst.ambiguousLookup"); //$NON-NLS-1$ 
		errorMessages[SEMANTIC_INVALID_TYPE - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.pst.invalidType"); //$NON-NLS-1$ 
		errorMessages[SEMANTIC_CIRCULAR_INHERITANCE - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.pst.circularInheritance"); //$NON-NLS-1$
		errorMessages[SEMANTIC_INVALID_OVERLOAD - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.pst.invalidOverload"); //$NON-NLS-1$
		errorMessages[SEMANTIC_INVALID_USING - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.pst.invalidUsing"); //$NON-NLS-1$
		errorMessages[SEMANTIC_DEFINITION_NOT_FOUND - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.dom.definitionNotFound"); //$NON-NLS-1$
		errorMessages[SEMANTIC_KNR_PARAMETER_DECLARATION_NOT_FOUND - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.dom.knrParameterDeclarationNotFound"); //$NON-NLS-1$
		errorMessages[SEMANTIC_LABEL_STATEMENT_NOT_FOUND - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.dom.labelStatementNotFound"); //$NON-NLS-1$
		errorMessages[SEMANTIC_INVALID_REDEFINITION - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.dom.invalidRedefinition"); //$NON-NLS-1$
		errorMessages[SEMANTIC_INVALID_REDECLARATION - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.dom.invalidRedeclaration"); //$NON-NLS-1$
		errorMessages[SEMANTIC_BAD_SCOPE - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.dom.badScope"); //$NON-NLS-1$
		errorMessages[SEMANTIC_MEMBER_DECLARATION_NOT_FOUND - 1] = ParserMessages
				.getString("ASTProblemFactory.error.semantic.dom.memberDeclNotFound"); //$NON-NLS-1$
	}

	/*
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IProblemBinding#getID()
	 */
	public int getID() {
		return id;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IProblemBinding#getMessage()
	 */
	public String getMessage() {
		if (message != null)
			return message;

		String msg = (id >= 0 && id <= LAST_PROBLEM) ? errorMessages[id - 1]
				: ""; //$NON-NLS-1$
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IScope#addName(edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTName)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IScope#removeBinding(edu.pdx.svl.coDoc.cdt.core.dom.ast.IBinding)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IScope#getBinding(edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTName,
	 *      boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IScope#setFullyCached(boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IScope#isFullyCached()
	 */
