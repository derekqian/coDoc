 ...
 * 
 */
public class ASTSimpleTypeSpecifier extends ASTNode implements
	 ...
	 * @param string
	 */
	public ASTSimpleTypeSpecifier(ISymbol s, boolean b, char[] string,
			List references) {
		this.symbol = s;
		this.isTypename = b;
		this.name = string;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#getType()
	 */
	public Type getType() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#getTypename()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#isLong()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#isShort()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#isSigned()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#isUnsigned()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#isTypename()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#getTypeSpecifier()
	 */
	public IASTTypeSpecifier getTypeSpecifier() {
		return (IASTTypeSpecifier) getSymbol().getTypeSymbol()
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#isComplex()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#isImaginary()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTSimpleTypeSpecifier#releaseReferences(edu.pdx.svl.coDoc.cdt.core.parser.ast.IReferenceManager)
	 */
