 ...
 * 
 */
public class ASTElaboratedTypeSpecifier extends ASTNode implements
	 ...
	 * @param filename
	 */
	public ASTElaboratedTypeSpecifier(IASTScope scope,
			ASTClassKind elaboratedClassKind, char[] typeName,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTElaboratedTypeSpecifier#getTypeName()
	 */
