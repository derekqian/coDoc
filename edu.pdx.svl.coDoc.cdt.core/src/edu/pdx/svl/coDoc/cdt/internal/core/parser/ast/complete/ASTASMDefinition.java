 ...
 * 
 */
public class ASTASMDefinition extends ASTAnonymousDeclaration implements
		IASTASMDefinition {
	 ...
	 * 
	 */
	public ASTASMDefinition(IContainerSymbol scope, char[] assembly, int first,
			int firstLine, int last, int lastLine, char[] filename) {
		super(scope);
