...
/**
 * The main purpose of this class is to provide a subclass of
 * GCCScannerExtensionConfiguration for exclusive use in the old parser
 * (ParserFactory.createScanner()) so that as old hacks are removed when fixed
 * in the new parser, they can still apply to the old parser. This way the old
 * parser will not have to be maintained as it's no longer being tested.
 * 
 * @author dsteffle
 */
