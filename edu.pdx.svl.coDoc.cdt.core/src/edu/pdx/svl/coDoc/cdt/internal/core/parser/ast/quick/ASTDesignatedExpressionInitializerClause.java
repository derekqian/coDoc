 ...
 * @author jcamelon
 */
public class ASTDesignatedExpressionInitializerClause extends
	 ...
	 * @param designators
	 */
	public ASTDesignatedExpressionInitializerClause(Kind kind,
			IASTExpression assignmentExpression, List designators) {
