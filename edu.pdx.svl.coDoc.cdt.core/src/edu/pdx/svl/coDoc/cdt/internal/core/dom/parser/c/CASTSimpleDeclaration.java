...
public class CASTSimpleDeclaration extends CASTNode implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTSimpleDeclaration#getDeclSpecifier()
	 */
	...
	public IASTDeclarator[] getDeclarators() {
		...
		declarators = (IASTDeclarator[]) ArrayUtil.removeNullsAfter(
				IASTDeclarator.class, declarators, declaratorsPos);
		return declarators;
	}
	...
	public void addDeclarator(IASTDeclarator d) {
		if (d != null) {
			...
			declarators = (IASTDeclarator[]) ArrayUtil.append(
					IASTDeclarator.class, declarators, d);
		}
	}
