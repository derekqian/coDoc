...
public class CPPDeferredFunctionInstance extends CPPInstance implements
	 ...
	 * @param argMap
	 */
	public CPPDeferredFunctionInstance(ICPPFunctionTemplate template,
			IType[] arguments) {
	...
	public IFunctionType getType() throws DOMException {
		if (functionType == null) {
			IFunctionType ft = ((ICPPFunction) getTemplateDefinition())
					.getType();
			IType returnType = ft.getReturnType();
			returnType = CPPTemplates.instantiateType(returnType,
					getArgumentMap());
			functionType = CPPVisitor.createImplicitFunctionType(returnType,
					getParameters());
		}
