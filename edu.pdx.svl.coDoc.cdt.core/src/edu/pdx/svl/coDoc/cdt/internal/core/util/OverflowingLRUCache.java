...
public abstract class OverflowingLRUCache extends LRUCache {
	 ...
	 * 
	 * This is required to create a cache with a hash map that is not dependent
	 * on the initial size of the cache (i.e. if the cache is relative to size
	 * of entries and not the number of entries).
	 */
	 ...
	 * 
	 * @param shuffle
	 *            indicates whether we are just shuffling the queue (i.e., the
	 *            entry table is left alone).
	 */
