...
import edu.pdx.svl.coDoc.cdt.internal.core.pdom.db.IBTreeComparator;
...
public abstract class PDOMNamedNode extends PDOMNode {
	...
	public PDOMNamedNode(PDOM pdom, PDOMNode parent, char[] name)
			throws CoreException {
		super(pdom, parent);

		Database db = pdom.getDB();
		db.putInt(record + NAME, name != null ? db.newString(name).getRecord()
				: 0);
