...
public class ASTFunction extends ASTScope implements IASTFunction {
	 ...
	 * @param filename
	 */
	public ASTFunction(IParameterizedSymbol symbol, int nameEndOffset,
			List parameters, IASTAbstractDeclaration returnType,
			IASTExceptionSpecification exception, int startOffset,
			int startingLine, int nameOffset, int nameLine,
			IASTTemplate ownerTemplate, List references,
			boolean previouslyDeclared, boolean hasFunctionTryBlock,
			boolean isFriend, char[] filename) {
		super(symbol);
		...
		qualifiedName = new ASTQualifiedNamedElement(getOwnerScope(), symbol
				.getName());
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#isInline()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#isFriend()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#isStatic()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#getReturnType()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#getParameters()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#getExceptionSpec()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#setHasFunctionBody(boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#hasFunctionBody()
	 */
	 ...
	 * @param manager
	 */
	protected void processParameterInitializersAndArrayMods(
			ISourceElementRequestor requestor) {
		int size = parameters.size();
		for (int i = 0; i < size; i++) {
			IASTParameterDeclaration parm = (IASTParameterDeclaration) parameters
					.get(i);
	...
	public IASTCodeScope getOwnerCodeScope() {
		return (getSymbol().getContainingSymbol().getASTExtension()
				.getPrimaryDeclaration()) instanceof IASTCodeScope ? (IASTCodeScope) getSymbol()
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#previouslyDeclared()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#setHasFunctionTryBlock(boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#hasFunctionTryBlock()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTFunction#takesVarArgs()
	 */
