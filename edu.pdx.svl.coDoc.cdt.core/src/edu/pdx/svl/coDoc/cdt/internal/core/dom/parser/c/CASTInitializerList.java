...
public class CASTInitializerList extends CASTNode implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTSimpleDeclaration#getDeclarators()
	 */
	public IASTInitializer[] getInitializers() {
		if (initializers == null)
			return IASTInitializer.EMPTY_INITIALIZER_ARRAY;
		initializers = (IASTInitializer[]) ArrayUtil.removeNullsAfter(
				IASTInitializer.class, initializers, initializersPos);
		return initializers;
	}
	...
	public void addInitializer(IASTInitializer d) {
		if (d != null) {
			initializersPos++;
			initializers = (IASTInitializer[]) ArrayUtil.append(
					IASTInitializer.class, initializers, d);
		}
	}
