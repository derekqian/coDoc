...
import edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICPointerType;
...
public class CQualifiedPointerType implements ICPointerType, ITypeContainer {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICPointerType#isRestrict()
	 */
	public boolean isRestrict() {
		if (mod == null || !(mod instanceof ICASTArrayModifier))
			return false;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IPointerType#getType()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IPointerType#isConst()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.IPointerType#isVolatile()
	 */
	...
	public boolean isSameType(IType type) {
		...
		if (type instanceof CQualifiedPointerType) {
			...
			if (qual.isConst() == isConst()
					&& qual.isRestrict() == isRestrict()
					&& qual.isVolatile() == isVolatile())
