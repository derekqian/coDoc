...
import edu.pdx.svl.coDoc.cdt.internal.core.dom.parser.cpp.CPPClassType.CPPClassTypeProblem;
...
public class CPPClassTemplate extends CPPTemplateDefinition implements
	...
	public static class CPPClassTemplateDelegate extends
			CPPClassType.CPPClassTypeDelegate implements ICPPClassTemplate,
		...
		public ICPPClassTemplatePartialSpecialization[] getPartialSpecializations()
				throws DOMException {
			return ((ICPPClassTemplate) getBinding())
		...
		public void addSpecialization(IType[] arguments,
			...
			((ICPPInternalTemplate) getBinding()).addSpecialization(arguments,
					specialization);
		}
		...
		public ICPPSpecialization deferredInstance(IType[] arguments) {
			return ((ICPPInternalTemplate) getBinding())
	...
	private void checkForDefinition() {
		...
		IASTNode node = CPPVisitor.getContainingBlockItem(declarations[0])
				.getParent();
	...
	public void addPartialSpecialization(
			ICPPClassTemplatePartialSpecialization spec) {
		partialSpecializations = (ICPPClassTemplatePartialSpecialization[]) ArrayUtil
				.append(ICPPClassTemplatePartialSpecialization.class,
						partialSpecializations, spec);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.internal.core.dom.parser.cpp.ICPPInternalClassType#getConversionOperators()
	 */
	...
	public ICPPClassTemplatePartialSpecialization[] getPartialSpecializations() {
		partialSpecializations = (ICPPClassTemplatePartialSpecialization[]) ArrayUtil
				.trim(ICPPClassTemplatePartialSpecialization.class,
