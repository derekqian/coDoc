...
import edu.pdx.svl.coDoc.cdt.core.model.ITemplate;
...
public class VariableTemplate extends Variable implements ITemplate {
	...
	public int getNumberOfTemplateParameters() {
		return templateParameterTypes == null ? 0
				: templateParameterTypes.length;
	}

	/*
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.model.ITemplate#getTemplateParameterTypes()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.model.ITemplate#setTemplateParameterTypes(java.lang.String[])
	 */
