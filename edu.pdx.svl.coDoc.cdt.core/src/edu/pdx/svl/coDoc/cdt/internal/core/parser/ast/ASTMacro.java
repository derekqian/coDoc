...
public class ASTMacro implements IASTMacro {
	...
	public ASTMacro(char[] name, int start, int startLine, int nameBeg,
			int nameEnd, int nameLine, int end, int endLine, char[] fn,
			boolean implicit) {
		this.name = name;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTMacro#getName()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IOffsetableElementRW#setStartingOffset(int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IOffsetableElementRW#setEndingOffset(int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IOffsetableElementRW#setNameOffset(int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.ast.IASTMacro#isImplicit()
	 */
