...
public interface ISymbol extends Cloneable, IExtensibleSymbol {
	 ...
	 *             Exceptions can be thrown when a IDeferredTemplateInstance
	 *             must be instantiated Reason: r_BadTemplateArgument if an
	 *             argument does not match the corresponding parameter type
	 *             r_Ambiguous if more than one specialization can be used but
