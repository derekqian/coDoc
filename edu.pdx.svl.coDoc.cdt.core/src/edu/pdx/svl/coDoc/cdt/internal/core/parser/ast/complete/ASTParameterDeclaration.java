 ...
 * 
 */
public class ASTParameterDeclaration extends ASTSymbol implements
	 ...
	 * @param filename
	 */
	public ASTParameterDeclaration(ISymbol symbol, boolean isConst,
			...
			int endingOffset, int endingLine, char[] filename) {
		super(symbol);
		abstractDeclaration = new ASTAbstractDeclaration(isConst, isVolatile,
	...
	public IASTFunction getOwnerFunctionDeclaration()
		...
		return (IASTFunction) getSymbol().getContainingSymbol()
