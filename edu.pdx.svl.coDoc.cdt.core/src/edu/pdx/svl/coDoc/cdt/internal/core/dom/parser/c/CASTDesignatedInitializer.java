...
public class CASTDesignatedInitializer extends CASTNode implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICASTDesignatedInitializer#addDesignator(edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICASTDesignator)
	 */
	public void addDesignator(ICASTDesignator designator) {
		if (designator != null) {
			designatorsPos++;
			designators = (ICASTDesignator[]) ArrayUtil.append(
					ICASTDesignator.class, designators, designator);
		}
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICASTDesignatedInitializer#getDesignators()
	 */
	public ICASTDesignator[] getDesignators() {
		if (designators == null)
			return ICASTDesignatedInitializer.EMPTY_DESIGNATOR_ARRAY;
		designators = (ICASTDesignator[]) ArrayUtil.removeNullsAfter(
				ICASTDesignator.class, designators, designatorsPos);
		return designators;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICASTDesignatedInitializer#getRHSInitializer()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.dom.ast.c.ICASTDesignatedInitializer#setRHSInitializer(edu.pdx.svl.coDoc.cdt.core.dom.ast.IASTInitializer)
	 */
