...
public interface IProblem {
	 ...
	 * 
	 * @return the line number in source where the problem begins, or -1 if
	 *         unknown
	 */
	...
	/**
	 * Attempt to use a symbol that was not found. Require attributes:
	 * A_SYMBOL_NAME
	 * 
	 * @see #A_SYMBOL_NAME
	 */
	...
	/**
	 * Name not provided in context that it was required. Require attributes:
	 * none
	 */
