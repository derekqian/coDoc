...
public interface ICModelStatusConstants {
	 ...
	 * copy. The translation unit on which the working copy is based has changed
	...
	/**
	 * Status constant indicating that a <code>DOMException</code> occurred.
	 */
	...
	/**
	 * Status indicating that a C element could not be created because the
	...
	/**
	 * Status indicating that a C element could not be created because the
	 * project owning underlying resource does not have the C nature.
	 * 
	 * @see CCore
	 */
