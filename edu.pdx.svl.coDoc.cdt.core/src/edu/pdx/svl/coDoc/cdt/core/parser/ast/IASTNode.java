...
public interface IASTNode {
	...
	public static class LookupKind extends Enum {
		...
		public static final LookupKind ALL = new LookupKind(0); // includes
																// everything

		public static final LookupKind STRUCTURES = new LookupKind(1); // includes
																		// STRUCTS
																		// +
																		// UNIONS
																		// +
		...
		public static final LookupKind TYPES = new LookupKind(17); // includes
																	// STRUCTURES
																	// +
																	// ENUMERATIONS
																	// +
