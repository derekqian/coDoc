...
public interface ICPPTemplateDefinition extends ICPPBinding {
	...
	/**
	 * Returns an array of the template parameters. In the case of a
	 * specialization, the array will be empty, a partial specialization will
	 * have the specialized parameter list
	 * 
