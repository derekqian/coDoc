...
import edu.pdx.svl.coDoc.cdt.internal.core.model.CModelStatus;

/**
 * A checked exception representing a failure in the C model. C model exceptions
 * contain a C-specific status object describing the cause of the exception.
 * 
 * @see ICModelStatus
...
public class CModelException extends CoreException {
	 ...
	 * <code>Throwable</code>. The exception contains a C-specific status
	 ...
	 *         if the direct case of the failure was at the C model layer
	 */
	...
	/**
	 * Returns the C model status object for this exception. Equivalent to
	 * <code>(ICModelStatus) getStatus()</code>.
	 * 
	 ...
	 * <code>ICModelStatusConstants.ELEMENT_DOES_NOT_EXIST</code>. This is a
	 * convenience method.
	 * 
