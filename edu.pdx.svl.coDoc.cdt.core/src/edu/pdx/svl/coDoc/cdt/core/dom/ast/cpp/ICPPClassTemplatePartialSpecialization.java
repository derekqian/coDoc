...
/**
 * This interface represents a class template partial specialization. A partial
 * specialization is a class template in its own right.
 * 
 * eg: template <class T> class A {}; //the primary class template template
 * <class T> class A<T*> {}; //a partial specialization of the primary class
 * template
 * 
 * @author aniefer
 */
public interface ICPPClassTemplatePartialSpecialization extends
		ICPPClassTemplate {
