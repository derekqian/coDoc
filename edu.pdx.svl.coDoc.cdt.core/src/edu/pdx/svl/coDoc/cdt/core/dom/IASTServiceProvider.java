 ...
 * 
 * IASTTranslationUnits and ASTCompletionNodes are artifacts that this service
 * returns.
 * 
 * @author jcamelon
 */
public interface IASTServiceProvider {
	...
	/**
	 * This exception is thrown when there is not a service provider that can
	 * handle the request due to dialect mis-match.
	 * 
	 * @author jcamelon
	 */
	 ...
	 * @see CDOM#getCodeReaderFactory(int)
	 * @param configuration
	 *            parser configuration provided rather than discovered by
	 *            service
	 * @return syntactical parse tree
	 * @throws UnsupportedDialectException
	 */
	 ...
	 *            the file in question
	 * @param offset
	 *            the offset at which you require completion at
	 * @param fileCreator
	 * @see CDOM#getCodeReaderFactory(int)
	 * @return syntactical parse tree
	 * @throws UnsupportedDialectException
	 ...
	 *            the file in question
	 * @param project
	 *            the project containing the scanner info
	 * @param offset
	 *            the offset at which you require completion at
	 * @param fileCreator
	 * @see CDOM#getCodeReaderFactory(int)
