 ...
 * 
 */
public class ExtendedScannerInfo extends ScannerInfo implements
	...
	public ExtendedScannerInfo(Map d, String[] incs, String[] macros,
			String[] includes) {
		super(d, incs);
		m = macros;
		i = includes;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IExtendedScannerInfo#getMacroFiles()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IExtendedScannerInfo#getIncludeFiles()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.parser.IExtendedScannerInfo#getLocalIncludePath()
	 */
