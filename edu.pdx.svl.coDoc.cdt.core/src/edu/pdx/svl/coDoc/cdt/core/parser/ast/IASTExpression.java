...
public interface IASTExpression extends ISourceElementCallbackDelegate,
		IASTNode, IASTOffsetableElement {
	public class Kind extends Enum {
		...
		static {
			...
			names.put(PRIMARY_BRACKETED_EXPRESSION,
					"PRIMARY_BRACKETED_EXPRESSION"); //$NON-NLS-1$
			...
			names.put(POSTFIX_SIMPLETYPE_UNSIGNED,
					"POSTFIX_SIMPLETYPE_UNSIGNED"); //$NON-NLS-1$
			...
			names.put(POSTFIX_TYPENAME_IDENTIFIER,
					"POSTFIX_TYPENAME_IDENTIFIER"); //$NON-NLS-1$
			names.put(POSTFIX_TYPENAME_TEMPLATEID,
					"POSTFIX_TYPENAME_TEMPLATEID"); //$NON-NLS-1$
			...
			names.put(POSTFIX_DOT_TEMPL_IDEXPRESS,
					"POSTFIX_DOT_TEMPL_IDEXPRESS"); //$NON-NLS-1$
			...
			names.put(UNARY_AMPSND_CASTEXPRESSION,
					"UNARY_AMPSND_CASTEXPRESSION"); //$NON-NLS-1$
			...
			names.put(UNARY_SIZEOF_UNARYEXPRESSION,
					"UNARY_SIZEOF_UNARYEXPRESSION"); //$NON-NLS-1$
			...
			names.put(DELETE_VECTORCASTEXPRESSION,
					"DELETE_VECTORCASTEXPRESSION"); //$NON-NLS-1$
			...
			names.put(RELATIONAL_GREATERTHANEQUALTO,
					"RELATIONAL_GREATERTHANEQUALTO"); //$NON-NLS-1$
			...
			names.put(ASSIGNMENTEXPRESSION_NORMAL,
					"ASSIGNMENTEXPRESSION_NORMAL"); //$NON-NLS-1$
			...
			names.put(ASSIGNMENTEXPRESSION_LSHIFT,
					"ASSIGNMENTEXPRESSION_LSHIFT"); //$NON-NLS-1$
			names.put(ASSIGNMENTEXPRESSION_RSHIFT,
					"ASSIGNMENTEXPRESSION_RSHIFT"); //$NON-NLS-1$
		...
		public boolean isLiteral() {
			if (this == PRIMARY_INTEGER_LITERAL || this == PRIMARY_CHAR_LITERAL
		...
		public boolean isBasicType() {
			if (this == PRIMARY_EMPTY || this == THROWEXPRESSION
					...
					|| this == EQUALITY_EQUALS || this == EQUALITY_NOTEQUALS
	...
	public interface IASTNewExpressionDescriptor extends
