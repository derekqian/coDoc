 ...
 * return a hierarchy of <code>ICElement</code>s which represent the
 * high-level structure of that file (what modules, classes, functions, and
 * similar constructs are contained in it, and on what line(s) the definition
 * occurs).
 * 
...
public interface IContributedModelBuilder {
	 ...
	 * <code>ILanguage#createModelBuilder</code>, which will presumably pass
	 * it on to the model builder constructor.
	 */
