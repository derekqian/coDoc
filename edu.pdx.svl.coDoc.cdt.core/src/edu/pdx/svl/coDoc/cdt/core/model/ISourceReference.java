 ...
 * has attached source code and debuging information.
 * 
 */
...
public interface ISourceReference {
	 ...
	 * </p>
	 * 
	 * @return the source range, or <code>null</code> if if this element has
	 ...
	 * <code>null</code> if this member is not declared in a translation unit
	 * (for example, a binary type).
	 * 
	 * @return
