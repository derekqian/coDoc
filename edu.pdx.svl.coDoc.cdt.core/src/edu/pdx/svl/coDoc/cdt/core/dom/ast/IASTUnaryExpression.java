...
public interface IASTUnaryExpression extends IASTExpression {
	...
	/**
	 * A bracketed expression. <code>op_bracketedPrimary</code> ==> ( exp )
	 */
	...
	/**
	 * <code>OPERAND</code> represents the relationship between an
	 * <code>IASTUnaryExpression</code> and it's nested
