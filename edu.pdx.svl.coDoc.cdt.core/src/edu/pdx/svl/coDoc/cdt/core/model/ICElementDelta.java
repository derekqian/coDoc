...
/**
 * A C element delta describes changes in a C element between two discrete
 ...
 * <code>getKind</code>) and its meaning:
 * <ul>
...
public interface ICElementDelta {
	...
	/**
	 * Change flag indicating that this is a fine-grained delta, i.e. an
	 ...
	 * <p>
	 * Note that resource deltas, like C element deltas, are generally only
