...
/**
 * Common protocol for C elements that support source code manipulations such as
...
public interface ISourceManipulation {
	 ...
	 *                <ul>
	 *                <li> This C element, container element, or sibling does
	 ...
	 */
	void copy(ICElement container, ICElement sibling, String rename,
	...
	void move(ICElement container, ICElement sibling, String rename,
			boolean replace, IProgressMonitor monitor) throws CModelException;
