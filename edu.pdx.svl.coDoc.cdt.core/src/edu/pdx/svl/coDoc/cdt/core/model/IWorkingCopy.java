 ...
 * created from. If a working copy is an <code>ICFile</code> and is explicitly
 * closed, the working copy's buffer will be thrown away. However, clients
 * should not explicitly open and close working copies.
 * </p>
 * <p>
