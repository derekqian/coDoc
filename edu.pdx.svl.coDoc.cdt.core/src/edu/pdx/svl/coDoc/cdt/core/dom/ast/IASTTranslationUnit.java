...
public interface IASTTranslationUnit extends IASTNode {
	...
	/**
	 * <code>OWNED_DECLARATION</code> represents the relationship between an
	 * <code>IASTTranslationUnit</code> and it's nested
	 * <code>IASTDeclaration</code>'s.
	 */
	...
	/**
	 * <code>SCANNER_PROBLEM</code> represents the relationship between an
	 * <code>IASTTranslationUnit</code> and it's nested
	...
	/**
	 * <code>PREPROCESSOR_STATEMENT</code> represents the relationship between
	 * an <code>IASTTranslationUnit</code> and it's nested
	 * <code>IASTPreprocessorStatement</code>.
	 */
	...
	/**
	 * Returns the array of definitions in this translation unit for the given
	 * binding. The array contains the IASTName nodes that define the binding.
	 * 
	 * @param binding
	 ...
	 * 
	 * @param path -
	 *            file name specified through path
	 * @param offset -
	 *            location in the file as an offset
	 * @param length -
	 *            length of selection
	...
	/**
	 * For a given range of locations, return a String that represents what is
	 * there underneath the range.
	 * 
	 * @param locations
	 ...
	 * 
	 * @param nodeLocations
	 *            <code>IASTNodeLocation</code>s to flatten
	 * @return null if not possible, otherwise, a file location representing
