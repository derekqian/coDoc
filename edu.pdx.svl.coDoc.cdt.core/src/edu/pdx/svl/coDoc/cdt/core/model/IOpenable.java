...
/**
 * An openable is an element that can be opened, saved, and closed. An openable
 * might or might not have an associated buffer.
 */
public interface IOpenable extends IBufferChangedListener {
	 ...
	 */
	boolean isOpen() throws CModelException;
	 ...
	 * translation units, a buffer is opened on the contents of the underlying
	 * resource.
	 */
	 ...
	 * a workspace resource operation.
	 * <p>
