...
public interface ICElement extends IAdaptable {
	...
	/**
	 * Constant representing a C Root workspace (IWorkspaceRoot object). A C
	 * element with this type can be safely cast to <code>ICModel</code>.
	 */
	static final int C_MODEL = 10;

	/**
	 * Constant representing a C project(IProject object). A C element with this
	 * type can be safely cast to <code>ICProject</code>.
	 */
	static final int C_PROJECT = 11;

	/**
	 * Constant representing a folder(ICContainer object). A C element with this
	 * type can be safely cast to <code>ICContainer</code>.
	 */
	...
	/**
	 * An unknown ICElement. Mainly used to determine what elements are not yet
	 * implemented. i.e. the new DOM Parser supports open declaration on labels,
	 * while the old parser did not
	 */
	 ...
	 * @param ancestorType
	 *            the given type
	 * @return the first ancestor of this C element that has the given type,
	...
	/**
	 * Returns the C project this element is contained in, or <code>null</code>
	 * if this element is not contained in any C project
	 * 
	 * @return the containing C project, or <code>null</code> if this element
	 *         is not contained in a C project
	 */
	...
	/**
	 * Returns the underlying resource that contains this element, or
	...
	/**
	 * Returns the Corresponding resource for this element, or <code>null</code>
	 * if this element does not have a corresponding resource.
	 * 
	 * @return the corresponding resource, or <code>null</code> if none
	 * @exception CModelException
	 *                if this element does not exist or if an exception occurs
	 *                while accessing its resource
	 */
	IResource getResource();

	/**
	 * Returns whether this C element is read-only. An element is read-only if
	 * its structure cannot be modified by the C model.
	 * 
	 ...
	 * a translation unit that could not be parsed, <code>false</code> is
