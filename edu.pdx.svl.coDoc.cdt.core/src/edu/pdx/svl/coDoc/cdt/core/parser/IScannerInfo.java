...
public interface IScannerInfo {
	 ...
	 * 
	 * If there are no defined symbols, the receiver will return an empty Map,
	 ...
	 * built-in include search paths followed by the user-defined include search
	 * paths.
	 * 
	 * If there are no paths defined, the receiver will return an empty array,
	 * never <code>null</code>
	 * 
	 * @return
	 */
