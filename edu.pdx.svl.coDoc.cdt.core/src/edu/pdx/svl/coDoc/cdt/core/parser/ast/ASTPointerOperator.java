...
public class ASTPointerOperator extends Enum {
	...
	public static final ASTPointerOperator CONST_POINTER = new ASTPointerOperator(
			2);

	public static final ASTPointerOperator VOLATILE_POINTER = new ASTPointerOperator(
			3);

	public static final ASTPointerOperator RESTRICT_POINTER = new ASTPointerOperator(
			4);
	...
	public boolean isStarOperator() {
		return ((this == VOLATILE_POINTER) || (this == CONST_POINTER)
				|| (this == RESTRICT_POINTER) || (this == POINTER));
	}
