...
/**
 * This is the external interface that all C and C++ parsers in the CDT must
 * implement.
 * 
 * @author jcamelon
 */
public interface IParser {
	...
	/**
	 * Request a parse from a pre-configured parser to parse a whole translation
	 * unit or file.
	 * 
	...
	/**
	 * @param offset
	 *            offset in the input file where code completion is being
	 *            requested for
	 * @return an IASTCompletionConstruct that provides a mechanism for
	 *         determining C/C++ code completion contributions
	 */
	...
	/**
	 * If an error was encountered, give us the offset of the token that caused
	 * the error.
	 * 
	 * @return -1 for no error, otherwise the character offset where we
	 *         encountered our first unrecoverable error.
	 */
