...
public interface ICExtensionReference {
	 ...
	 * <p>
	 * The ICExtension is instantiated using its 0-argument public constructor.
	 * If the class implements the
	 * <code>org.eclipse.core.runtime.IExecutableExtension</code> interface,
	 * the method <code>setInitializationData</code> is called, passing to the
	...
	/**
	 * Returns all configuration elements that are children of the cextension
