...
public class ScannerInfo implements IExtendedScannerInfo {
	...
	protected ScannerInfo(String[] systemIncludePaths,
			String[] localIncludePaths, String[] includeFiles, Map macroMap,
			String[] macroFiles) {
		fSystemIncludePaths = (systemIncludePaths == null) ? EMPTY_ARRAY_STRING
				: systemIncludePaths;
		fLocalIncludePaths = (localIncludePaths == null) ? EMPTY_ARRAY_STRING
				: localIncludePaths;
		fIncludeFiles = (includeFiles == null) ? EMPTY_ARRAY_STRING
				: includeFiles;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.pdx.svl.coDoc.cdt.core.build.managed.IScannerInfo#getIncludePaths()
	 */
