 ...
 * 
 * An instance of a class template will also implement ICPPClassType and
 * similarily a function template instance will also implement ICPPFunction (or
 * even ICPPMethod or ICPPConstructor as appropriate)
 * 
 * @author aniefer
 */
