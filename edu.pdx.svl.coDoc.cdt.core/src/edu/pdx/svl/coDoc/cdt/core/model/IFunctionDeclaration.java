...
public interface IFunctionDeclaration extends IDeclaration {
	 ...
	 * 
	 * <p>
	 * For example, a source method declaring
	 * <code>"void f(int a) throw (x1, x2);"</code>, would return the array
	 * <code>{"x1", "x2"}</code>.
	 * 
	...
	/**
	 * Returns the initializer of parameters position for this method. Returns
	 * an empty string if this argument has no initializer.
	 * 
	 * <p>
	 * For example, a method declared as
	 * <code>public void foo(String text, int length=9)</code> would return
	 * the array <code>{"9"}</code>.
	 * 
	 * @exception CModelException
	 *                if this argument does not exist or if an exception occurs
	 *                while accessing its corresponding resource.
	 */
	 ...
	 * <code>void foo(string text, int length)</code> would return the array
