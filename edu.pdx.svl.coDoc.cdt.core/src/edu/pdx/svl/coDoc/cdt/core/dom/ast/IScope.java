...
public interface IScope {
	...
	/**
	 * Scopes are arranged hierarchically. Lookups will generally flow upward to
	 * find resolution.
	 * 
	 * @return
	 */
	...
	/**
	 * This is the general lookup entry point. It returns the list of valid
	 * bindings for a given name. The lookup proceeds as an unqualified lookup.
	 * Constructors are not considered during this lookup and won't be returned.
	 * No attempt is made to resolve potential ambiguities or perform access
	 * checking.
	 * 
	 * @param searchString
	 ...
	 * return null if there is no matching binding in this scope, if the binding
	 * has not yet been cached in this scope, or if resolve == false and the
	 * appropriate binding has not yet been resolved.
	 * 
	 * @param name
	 * @param resolve :
	...
	/**
	 * This adds an IBinding to the scope. It is primarily used by the parser to
	 * add implicit IBindings to the scope (such as GCC built-in functions).
	 * 
	 * @param binding
	 * @throws DOMException
	 */
