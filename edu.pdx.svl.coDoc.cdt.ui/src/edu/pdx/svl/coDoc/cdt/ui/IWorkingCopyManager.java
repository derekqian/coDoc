...
public interface IWorkingCopyManager {
	 ...
	 * method, a working copy will be available for the translation unit encoded
	 ...
	 *                if the working copy cannot be created for the translation
	 *                unit
	 */
	 ...
	 * method, a working copy for the translation unit encoded in the given
	 * editor input will no longer be available. Does nothing if there is no
	 * encoded translation unit, or if there is no remembered working copy for
	 ...
	 * @param input
	 *            the editor input
	 * @return the working copy of the translation unit, or <code>null</code>
	 *         if the input does not encode an editor input, or if there is no
	 *         remembered working copy for this translation unit
	 */
