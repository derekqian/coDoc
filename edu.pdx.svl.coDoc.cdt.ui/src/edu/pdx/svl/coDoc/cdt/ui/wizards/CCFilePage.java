 ...
 */
public class CCFilePage extends WizardNewFileCreationPage 
{
  private IWorkbench workbench;
  private Button sectionCheckbox;
  private Button subsectionCheckbox;
  private String suffix = new String(".bbcc");
  private static int nameCounter = 1;

  public CCFilePage(IWorkbench workbench, IStructuredSelection selection) 
  {
  ...
  public void createControl(Composite parent) 
  {
    ...
    final String[] fileTypes = new String[] {".bbcc", ".bbhh"};
    ...
    radios[0].setText("Source file (*.bbcc)");
    radios[0].pack();

    radios[1] = new Button(group, SWT.RADIO);
    radios[1].setText("Header file (*.bbhh)");
    radios[1].pack();
