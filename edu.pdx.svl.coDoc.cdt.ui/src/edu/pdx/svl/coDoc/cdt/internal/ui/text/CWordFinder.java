...
public class CWordFinder {
	...
	/**
	 * This method will determine whether current offset is contained in any
	 * function's body or it's outside it.
	 * 
	 * @param document
	 *            The document to be examined
	 * @param offset
	 *            The offset into the document
	 * @return <code>true</code> if there is no function body around offset
			...
			while (pos > 0) {
				...
				if (c == CBRACE_R) {
					...
					if (bracketcount-- == 0) {
						...
						// container block seems to be not a function or
						// statement body
