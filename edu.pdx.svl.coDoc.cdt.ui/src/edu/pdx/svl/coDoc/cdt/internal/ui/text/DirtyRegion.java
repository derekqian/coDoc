...
public class DirtyRegion implements ITypedRegion {
	 ...
	 * @param type
	 *            the type of change that this region represents:
	 *            {@link #INSERT} {@link #REMOVE}
	 * @param text
	...
	/**
	 * Computes the normalized type value to ensure that the implementation can
	 * use object identity rather than equality.
	 * 
	 * @param type
	 *            the type value
