...
/*******************************************************************************
 * Copyright (c) 2000, 2005 QNX Software Systems and others. All rights
...
public interface ICColorConstants {
	...
	/*
	 * The color key for everthing in C code for which no other color is
	 * specified.
	 */
	String C_DEFAULT = "c_default"; //$NON-NLS-1$

	/**
	 * The color key for task tags in C comments (value
