...
#include <jni.h>
/* Header for class edu_pdx_svl_coDoc_poppler_PopplerJNI */

#ifndef _Included_edu_pdx_svl_coDoc_poppler_PopplerJNI
#define _Included_edu_pdx_svl_coDoc_poppler_PopplerJNI
#ifdef __cplusplus
extern "C" {
#endif
/*
