 ...
 *
 */
public class PDFReader extends Canvas implements PaintListener, IPreferenceChangeListener{
     ...
     */
    public PDFReader(Composite parent/*, final CDCEditor editor*/) {
