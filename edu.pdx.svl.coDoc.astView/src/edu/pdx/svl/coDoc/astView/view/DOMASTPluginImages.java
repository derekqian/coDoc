...
import edu.pdx.svl.coDoc.astView.Activator;

/**
 * @author dsteffle
 */
public class DOMASTPluginImages {
	private static ImageRegistry imageRegistry = new ImageRegistry(PlatformUI.getWorkbench().getDisplay());
	...
	public static final String PLUGIN_ID = "edu.pdx.svl.coDoc.astView"; //$NON-NLS-1$
